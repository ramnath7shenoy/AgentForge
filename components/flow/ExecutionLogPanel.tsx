...
const ExecutionLogPanel: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-full border-t md:border-t-0 md:border-l border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-900 overflow-hidden min-h-0">
      {/* Header */}
      <div className="flex border-b border-gray-200 dark:border-slate-800 shrink-0">
        <div
          className="flex-1 py-2 text-[10px] font-black uppercase tracking-widest text-indigo-500 border-b-2 border-indigo-500 bg-indigo-500/5 text-center"
        >
          Logs
        </div>
      </div>
