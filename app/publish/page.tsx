...
export default function PublishPage() {
  ...
  const handleRunPreview = async () => {
    ...
    if (startNode) await simulateFlow(startNode.id);
  };
                    ...
                    {finalResult.type === "text" ? (
                      ...
                      <div className="flex flex-col items-center gap-5 p-8 bg-background rounded-xl border border-border shadow-inner">
                        ...
                        <a
                          ...
                          className="px-6 py-2.5 bg-slate-800 hover:bg-slate-700 text-white text-[10px] font-black uppercase tracking-widest rounded-xl transition-all flex items-center gap-2 border border-slate-700"
                        >
                          <Download size={14} />
                          Download Asset
                        </a>
